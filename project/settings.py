...
CSRF_TRUSTED_ORIGINS = [
    "http://ridenew-production-e7e3.up.railway.app",
    "https://ridenew-production-e7e3.up.railway.app",
]
...
if DEBUG:
    ...
    DATABASES = {
        "default": {
            ...
            "PASSWORD": "ZDqWWYQyLLfLfIYclWkpeulpMDizTCxe",  # Replace with your actual DB password
    ...
    REDIS_USER = "default"
    REDIS_PASSWORD = "eGPnXGvMNcDXQOCPoytWKcyPQcduWUsm"
